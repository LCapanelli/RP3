...
{
    ui->setupUi(this);
    ui->tW_showDiagnosReadyOnly->setColumnCount(9);
    QStringList labelList;
    labelList << "ID"<< "Título" << "Taxonomia" << "Ano" << "Domínio" << "Classe"
...
void Explorer::listUpdate(){
    QDjangoQuerySet <Diagnostico> idDiag ,nomeD, num01, num02, idDom, idClasse, definicao, cDefin, fRelac;
    QList<qint32> idList;
    QList <int> idDomList, idClassList;
    ...
    for(int i = 0; i < nameList.count(); ++i){
        ...
        ui->tW_showDiagnosReadyOnly->setItem(i, 2, new QTableWidgetItem(num01List.at(i)));
        ...
        ui->tW_showDiagnosReadyOnly->setItem(i, 6, new QTableWidgetItem(defList.at(i)));
        ui->tW_showDiagnosReadyOnly->setItem(i, 7, new QTableWidgetItem(cDList.at(i)));
        ui->tW_showDiagnosReadyOnly->setItem(i, 8, new QTableWidgetItem(fRelList.at(i)));
    }
